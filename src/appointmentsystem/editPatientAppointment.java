...
public class editPatientAppointment extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String pdat= pd.getText();
         try{ Class.forName("com.mysql.jdbc.Driver");
        Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/appsys","root","");
        
        String sql = "update `patient_record` SET `PatientName`='"+pname+"',`appdate`='"+pdat+"'WHERE id='"+pid+"'";
...
LoginPage obj =new LoginPage();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editPatientAppointment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new editPatientAppointment().setVisible(true);
            }
        });
    }
